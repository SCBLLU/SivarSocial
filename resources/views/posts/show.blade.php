            ...
            <div class="flex flex-col lg:flex-row gap-4 lg:gap-8 w-full justify-center items-start">
                ...
                @else
                    ...
                    <div id="post-container"
                        ...
                        <div class="w-full flex justify-center bg-neutral-900 rounded-2xl min-h-80" style="min-height:20rem;">
                            <img src="{{ asset('uploads') . '/' . $post->imagen }}" alt="Imagen del post {{ $post->titulo }}"
                                class="object-contain w-full max-h-96 sm:max-h-[500px] lg:max-h-96 bg-neutral-900 mb-0"
