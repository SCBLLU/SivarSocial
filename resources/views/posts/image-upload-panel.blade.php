...
<div class="text-center">
    ...
    <div id="upload-area" class="border-2 border-dashed border-gray-300 rounded-xl p-8 transition-all hover:border-blue-400 hover:bg-blue-50/50 cursor-pointer">
    ...
    <div class="mobile-only-controls mt-4 gap-3 justify-center hidden">
        <button type="button" id="open-camera" class="flex-1 bg-blue-500 text-white px-4 py-3 rounded-xl font-medium flex items-center justify-center gap-2 hover:bg-blue-600 transition-colors">
            <i class="fas fa-camera"></i>
            Tomar Foto
        </button>
        <button type="button" id="open-gallery" class="flex-1 bg-gray-500 text-white px-4 py-3 rounded-xl font-medium flex items-center justify-center gap-2 hover:bg-gray-600 transition-colors">
    ...
    <div id="image-preview" class="hidden mt-6">
        <div class="relative inline-block">
            ...
            <button type="button" id="remove-image" class="absolute -top-2 -right-2 w-8 h-8 bg-red-500 text-white rounded-full flex items-center justify-center hover:bg-red-600 transition-colors">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (isMobile && mobileControls) {
        ...
        console.log('Mobile controls hidden - Desktop mode');
    }
    ...
    if (!isMobile && cameraOverlay) {
        ...
        console.log('Camera overlay forcibly hidden on desktop');
    }
    
    console.log('Device detection:', { isMobile, userAgent: navigator.userAgent, width: window.innerWidth });
    ...
    async function openCameraModal() {
        ...
        if (!isMobile) {
            console.log('Camera access blocked on desktop');
