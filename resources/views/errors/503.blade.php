    ...
    <div class=" flex items-center justify-center">
        <div class="w-full max-w-2xl mx-auto text-center">
            ...
            <div class="bg-white rounded-2xl shadow-xl p-8 md:p-12">
                ...
                <div class="mb-8">
                    {{-- Número 503 --}}
                    <h1 class="text-8xl md:text-9xl font-bold text-yellow-600 mb-4">
                        503
                    </h1>
                </div>
                ...
                <div class="mb-8">
                    ...
                    <p class="text-gray-600 text-lg mb-6 max-w-md mx-auto">
                        SivarSocial está temporalmente fuera de servicio por mantenimiento. Volveremos pronto con mejoras.
                    </p>
                </div>
