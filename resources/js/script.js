setTimeout(() => {
          ...
          if (alert) {
              alert.classList.add('fade-out'); // Activa la animación de salida
              setTimeout(() => alert.remove(), 500); // Espera que termine antes de remover
          }
      }, 10000); // Desaparece después de 4 segundos
